(function ($) {
    ...
    if ($.fn.owlCarousel){
        ...
        $(".jexpress-hero-slides").owlCarousel({
            items: 1,
            loop: true,
            autoplay: true,
            smartspeed: 2000,
        ...
        var wel_slides = $('.jexpress-hero-slides');
        ...
        wel_slides.on('translate.owl.carousel', function (event) {
            ...
            $('hero-slides-nav h2').removeClass('animated').hide();
            $('hero-content nav, jexpress-hero-area .owl-next').removeClass('animated').hide();
        })
        wel_slides.on('translated.owl.carousel', function (event){
            ...
            $('.hero-slides-nav, .jexpress-hero-area .owl-next').addClass('animated fadeInUp').show();
        })
    
        // Menu Slider Active Code
        $(".jexpress-menu-slides").owlCarousel({
            items: 1,
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
    ...
    if ($.fn.imagesLoaded) {
        $('.jexpress-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.jexpress-portfolio').isotope({
